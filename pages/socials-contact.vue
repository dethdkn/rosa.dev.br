...
<template>
    <section class="min-h-[calc(100vh-2rem)] flex items-center justify-center relative">
        <div class="bg-gray-200/80 dark:bg-slate-800 rounded-xl m-5 lg:mx-60 p-4">
            <a href="mailto:gabriel@rosa.dev.br" target="_blank" class="block text-gray-600 dark:text-white px-4 py-3 hover:bg-gradient-to-r hover:from-sky-600 hover:to-cyan-400 rounded-2xl">
                <FaIcon icon="envelope" class="transform translate-y-[0.45rem] p-1 bg-blue-400 dark:bg-sky-500 rounded-full"/>
                <span> gabriel@rosa.dev.br</span>
            </a>
            <a href="https://www.linkedin.com/in/gabrielsdrosa" target="_blank" class="block text-gray-600 dark:text-white px-4 py-3 hover:bg-gradient-to-r hover:from-sky-600 hover:to-cyan-400 rounded-2xl">
