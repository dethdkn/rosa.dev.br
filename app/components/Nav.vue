  ...
  <nav class="bg-pearl dark:bg-onyx border-b border-gray-200 dark:border-gray-800">
    <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between p-4">
      <NuxtLink to="/" class="group flex items-center">
        ...
        <span
          class="font-delius text-obsidian group-hover:text-candy dark:text-snow dark:group-hover:text-candy self-center text-2xl font-semibold whitespace-nowrap"
          >Gabriel Rosa</span
        >
      </NuxtLink>
      ...
      <div
        ...
        <ul
          class="bg-pearl dark:bg-onyx mt-4 flex flex-col rounded-lg border border-stone-300 p-4 font-medium lg:mt-0 lg:flex-row lg:space-x-8 lg:border-0 lg:p-0 dark:border-gray-700">
          <li v-for="route in routes" :key="route.path">
            <NuxtLinkLocale
              :to="route.path"
              class="text-obsidian dark:text-snow lg:border-candy/0 hover:lg:border-candy lg:hover:text-candy hover:lg:dark:border-candy lg:dark:hover:text-candy block rounded border-transparent py-2 pr-4 pl-3 hover:bg-gray-200 lg:rounded-none lg:border-b-2 lg:p-0 lg:hover:bg-transparent dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent"
