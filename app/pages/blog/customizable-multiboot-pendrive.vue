...
<template>
  <div class="mx-auto max-w-7xl">
    ...
    <div class="mt-10 space-y-5 px-10 text-obsidian dark:text-snow">
      ...
      <iframe class="m-auto h-60 w-full rounded-lg sm:h-80 md:h-100 lg:h-120 xl:h-160" src="https://www.youtube.com/embed/nunxSwZ2xfA" title="Pendrive Multiboot Personalizável (pra mostrar pros seus amiguinhos do TI e não ensinar a fazer)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
      <p>{{ t('posts.customizable_multiboot_pendrive.paragraph1') }}</p>
      <div>
        <!-- eslint-disable-next-line vue/no-bare-strings-in-template -->
        <NuxtLink to="https://www.ventoy.net/en/download.html" external target="_blank" class="inline-block border-b-2 text-obsidian hover:border-candy hover:text-candy dark:text-snow hover:dark:border-candy dark:hover:text-candy">
          Download Ventoy
        </NuxtLink>
      </div>
      <div>
        <!-- eslint-disable-next-line vue/no-bare-strings-in-template -->
        <NuxtLink to="https://www.ventoy.net/en/plugin_theme.html" external target="_blank" class="inline-block border-b-2 text-obsidian hover:border-candy hover:text-candy dark:text-snow hover:dark:border-candy dark:hover:text-candy">
          Ventoy Theme Plugin
        </NuxtLink>
      </div>
      <div>
        <!-- eslint-disable-next-line vue/no-bare-strings-in-template -->
        <NuxtLink to="https://rosa.dev.br/downloads/lavenza.zip" target="_blank" class="inline-block border-b-2 text-obsidian hover:border-candy hover:text-candy dark:text-snow hover:dark:border-candy dark:hover:text-candy">
          Lavenza Theme
        </NuxtLink>
      </div>
