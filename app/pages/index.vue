...
<template>
  <div class="flex flex-wrap items-center justify-center space-x-6 pt-16">
    <div ref="image" class="group relative size-48 cursor-pointer overflow-hidden rounded-full border-4 border-candy" role="button" @click="pinkBlast" @keydown.enter="pinkBlast">
    ...
    <div class="space-y-2 text-center">
      <i18n-t scope="global" keypath="home.im" tag="h1" class="mb-2 text-4xl text-obsidian dark:text-snow">
        <template #name>
      ...
      <h3 class="cursor-default text-sm text-obsidian opacity-0 transition-all duration-500 dark:text-snow" :class="{'cursor-text opacity-100': hovered}">
        {{ t('home.drawn_by') }}
      </h3>
    </div>
  </div>
